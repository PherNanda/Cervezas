package com.android.cervezas.data.provider

import com.android.cervezas.BuildConfig
            ...
            .addNetworkInterceptor { chain ->
                chain.proceed(
                    chain.request()
                        ...
                        .header(
                            "User-Agent",
                            "Android:${BuildConfig.APP_NAME} Version:${BuildConfig.VERSION_NAME} Package:${BuildConfig.PACKAGE_NAME} Framework:$TAG/4.4.0"
                        )
                        .build()
                )
            }
